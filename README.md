...
Figure 1.   The iterative training process for psychosis identification. i denotes the number of iterations. F1 was for model evaluation during training & validation due to class imbalance.
...
Topic modeling reveals an evolving trend of training data themes. Initial rounds emphasize psychotic symptoms and hallucinations, indicating an acute focus on immediate mental health concerns. As the iterations progressed, there was a noticeable shift towards broader themes like patient history and functioning. 
